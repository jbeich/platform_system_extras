...
struct fec_handle {
    ...
    hashtree_info hashtree() const { return verity.hashtree; }

    uint64_t filesystem_size() const {
      return verity.data_blocks * FEC_BLOCKSIZE;
    }
};
...
extern bool verity_check_block(const uint8_t *expected, const uint8_t *block,
