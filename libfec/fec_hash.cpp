...
uint64_t hashtree_get_size(uint64_t file_size, uint32_t *verity_levels,
...
int hashtree_info::verify_tree(const fec_handle *f, const uint8_t *root) {
    ...
    uint64_t hash_size = hashtree_get_size(data_blocks * FEC_BLOCKSIZE, &levels,
    ...
    hashtree_get_size(data_blocks * FEC_BLOCKSIZE, NULL, hashes,
