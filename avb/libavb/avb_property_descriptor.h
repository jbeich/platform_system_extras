 ...
 * name |key| in a vbmeta image. If |key| is NUL-terminated,
...
/* Like avb_property_lookup() but parses the value as an unsigned
...
int avb_property_lookup_uint64(const uint8_t* image_data, size_t image_size,
                               ...
                               uint64_t* out_value) AVB_ATTR_WARN_UNUSED_RESULT;
