 ...
 * the documentation for |AvbVBMetaImageHeader| except for the data in
 ...
 * order, use the function avb_rsa_public_key_header_to_host_byte_order().
 *
 ...
 */
int avb_rsa_public_key_header_validate_and_byteswap(
