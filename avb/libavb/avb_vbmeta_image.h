...
typedef struct AvbVBMetaImageHeader {
  ...
  /*  20: The size of the auxilary data block. */
  ...
  /*  64: Offset into the "Auxilary data" block of public key data. */
  uint64_t public_key_offset;
  /*  72: Length of the public key data. */
  uint64_t public_key_size;

  /*  80: Offset into the "Auxilary data" block of descriptor data. */
 ...
 * four blocks (header, authentication, auxilary, payload) that make
 * up a vbmeta image.
 *
 ...
 *      to extract the key at build time and compare it to what is
 *      returned in |out_public_key_data|.
 *
