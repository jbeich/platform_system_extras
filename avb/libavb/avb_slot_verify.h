...
/* Data structure containing data in a slot needed to boot it. This is
 * returned by avb_slot_verify() if the image successfully verifies.
 *
 ...
 * other partitions (with |ab_suffix| appended), and inspecting
 * rollback indexes and checking if the public key used to sign the
 * data is acceptable. The functions in |ops| will be used to do this.
 *
