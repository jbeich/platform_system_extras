...
class MyOps {
 public:
  ...
  int read_is_device_unlocked(AvbOps* ops, int* out_is_device_unlocked) {
...
static int my_ops_validate_vbmeta_public_key(AvbOps* ops,
...
static int my_ops_read_is_device_unlocked(AvbOps* ops,
                                          int* out_is_device_unlocked) {
  return ((MyAvbOps*)ops)
