...
The raw tracing data need to be combined with the original binary to create the AutoFDO branch list.
This is a costly process, thus it is not done along with the profile collection. Profcollect
...
More profile data usually generate better quality profiles. You may combine data from multiple
