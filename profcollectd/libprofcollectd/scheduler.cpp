...
static constexpr const config_t CONFIG_COLLECTION_INTERVAL_SEC = {"collection_interval_s", "600"};
static constexpr const config_t CONFIG_SAMPLING_PERIOD_MS = {"sampling_period_ms", "500"};
...
OptError ProfcollectdScheduler::ReadConfig() {
  ...
  config.samplingPeriod = std::chrono::milliseconds(getConfigFlagInt(CONFIG_SAMPLING_PERIOD_MS));
