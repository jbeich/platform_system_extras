...
func (g *gkiApex) createModulesForFactoryApex(mctx android.LoadHookContext) {
	...
	apexName := "com.android.gki." + g.properties.KmiVersionStruct.toPackageSuffix()
...
// e.g. com.android.gki.kmi_5_4_android12_0_factory
...
// e.g. com.android.gki.kmi_5_4_android12_0_factory_all
