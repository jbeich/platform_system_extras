...
#define TEST_STRING(first_api_level, instring, outstring) \
    ...
    options = TestString(first_api_level, instring, outstring);
...
TEST(fscrypt, ParseOptions) {
    ...
    for (const auto& d : defaults) {
        ...
        EXPECT_TRUE(ParseOptionsForApiLevel(30, d, &options));
    ...
    EXPECT_FALSE(ParseOptionsForApiLevel(29, "blah", &options));
    EXPECT_FALSE(ParseOptionsForApiLevel(30, "blah", &options));
    ...
    EXPECT_FALSE(ParseOptionsForApiLevel(29, "ice:blah", &options));
    ...
    EXPECT_FALSE(ParseOptionsForApiLevel(29, "adiantum:aes-256-cts", &options));
    EXPECT_FALSE(ParseOptionsForApiLevel(30, "adiantum:aes-256-cts", &options));
    EXPECT_FALSE(ParseOptionsForApiLevel(29, "aes-256-xts:adiantum", &options));
    EXPECT_FALSE(ParseOptionsForApiLevel(30, "aes-256-xts:adiantum", &options));
    {
    ...
    EXPECT_FALSE(ParseOptionsForApiLevel(29, "aes-256-xts:aes-256-cts:v2:", &options));
    EXPECT_FALSE(ParseOptionsForApiLevel(29, "aes-256-xts:aes-256-cts:v2:foo", &options));
    EXPECT_FALSE(ParseOptionsForApiLevel(29, "aes-256-xts:aes-256-cts:blah", &options));
    EXPECT_FALSE(ParseOptionsForApiLevel(29, "aes-256-xts:aes-256-cts:vblah", &options));
    EXPECT_FALSE(ParseOptionsForApiLevel(30, "aes-256-xts:aes-256-cts:v2:", &options));
    EXPECT_FALSE(ParseOptionsForApiLevel(30, "aes-256-xts:aes-256-cts:v2:foo", &options));
    EXPECT_FALSE(ParseOptionsForApiLevel(30, "aes-256-xts:aes-256-cts:blah", &options));
    EXPECT_FALSE(ParseOptionsForApiLevel(30, "aes-256-xts:aes-256-cts:vblah", &options));
}
