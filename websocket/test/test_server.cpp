...
class EchoHandler : public android::ws::WebSocketHandler {
  public:
    EchoHandler(struct lws* wsi) : WebSocketHandler(wsi) {}
...
int main(int argc, char** argv) {
    ...
    auto increment_handler_factory_p =
            std::unique_ptr<android::ws::WebSocketHandlerFactory>(new EchoHandlerFactory());
    wss.RegisterHandlerFactory(kEchoUriPath, std::move(increment_handler_factory_p));
