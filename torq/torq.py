...
def create_hw_command(args):
  ...
  if args.hw_subcommand == "set":
    return HWCommand(type, args.config, args.num_cpus,
                        args.memory)
  else:
    return HWCommand(type, None, None, None)


def create_config_command(args):
  type = "config " + args.config_subcommand
  if args.config_subcommand == "pull":
    return ConfigCommand(type, args.config_name,
                            args.file_path)
  if args.config_subcommand == "show":
    return ConfigCommand(type, args.config_name, None)
  if args.config_subcommand == "list":
    return ConfigCommand(type, None, None)
