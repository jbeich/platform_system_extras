...
class ProfilerCommand(Command):
  """
  Class representing a profiler command. Will be used to profile traces.
  """
...
class HWCommand(Command):
  """
  Class representing a hw command. Will be used to get information from or
  change the current device's hardware.
  """
...
class ConfigCommand(Command):
  """
  Class representing a config command. Will be used to get information about
