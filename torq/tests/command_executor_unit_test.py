...
class CommandExecutorUnitTest(unittest.TestCase):

  @mock.patch.object(ProfilerCommandExecutor, "create_config", autospec=True)
  def test_execute_command_create_config_failure(self, mock_create_config):
    mock_command = "mock-command"
    mock_error = ValidationError(MOCK_ERROR, None)
    mock_create_config.return_value = None, mock_error
  ...
  @mock.patch.object(ProfilerCommandExecutor, "create_config", autospec=True)
  def test_execute_command_prepare_device_failure(self, mock_create_config,
      mock_prepare_device):
    mock_command = "mock-command"
    mock_error = ValidationError(MOCK_ERROR, None)
    mock_create_config.return_value = MOCK_CONFIG, None
  ...
  def test_execute_command_prepare_device_for_run_failure(self,
      mock_create_config, mock_prepare_device_for_run):
  ...
  @mock.patch.object(ProfilerCommandExecutor, "prepare_device_for_run",
                     autospec=True)
  @mock.patch.object(ProfilerCommandExecutor, "create_config", autospec=True)
  def test_execute_command_execute_run_failure(self, mock_create_config,
  ...
  @mock.patch.object(ProfilerCommandExecutor, "prepare_device_for_run",
                     autospec=True)
  @mock.patch.object(ProfilerCommandExecutor, "create_config", autospec=True)
  def test_execute_command_retrieve_perf_data_failure(self, mock_create_config,
  ...
  @mock.patch.object(ProfilerCommandExecutor, "prepare_device_for_run",
                     autospec=True)
  @mock.patch.object(ProfilerCommandExecutor, "create_config", autospec=True)
  def test_execute_command_cleanup_failure(self, mock_create_config,
      mock_prepare_device_for_run, mock_execute_run, mock_retrieve_perf_data,
      mock_cleanup):
    mock_command = mock.create_autospec(ProfilerCommand, instance=True)
    mock_command.runs = 1
  ...
  @mock.patch.object(ProfilerCommandExecutor, "prepare_device_for_run",
                     autospec=True)
  @mock.patch.object(ProfilerCommandExecutor, "create_config", autospec=True)
  def test_execute_command_use_ui_failure(self, mock_create_config,
      mock_prepare_device_for_run, mock_execute_run, mock_retrieve_perf_data,
      mock_open_ui):
    mock_command = mock.create_autospec(ProfilerCommand, instance=True)
    mock_command.runs = 1
  ...
  @mock.patch.object(ProfilerCommandExecutor, "prepare_device_for_run",
                     autospec=True)
  @mock.patch.object(ProfilerCommandExecutor, "create_config", autospec=True)
  def test_execute_command_use_ui_success(self, mock_create_config,
      mock_prepare_device_for_run, mock_execute_run, mock_retrieve_perf_data,
      mock_open_ui):
    mock_command = mock.create_autospec(ProfilerCommand, instance=True)
    mock_command.runs = 1
  ...
  @mock.patch.object(ProfilerCommandExecutor, "prepare_device_for_run",
                     autospec=True)
  @mock.patch.object(ProfilerCommandExecutor, "create_config", autospec=True)
  def test_execute_command_no_ui_success(self, mock_create_config,
      mock_prepare_device_for_run, mock_execute_run, mock_retrieve_perf_data):
    mock_command = mock.create_autospec(ProfilerCommand, instance=True)
    mock_command.runs = 1
  ...
  @mock.patch.object(ProfilerCommandExecutor, "prepare_device_for_run",
                     autospec=True)
  @mock.patch.object(ProfilerCommandExecutor, "create_config", autospec=True)
  def test_execute_command_print_current_run_success(self, mock_create_config,
      mock_prepare_device_for_run, mock_execute_run, mock_retrieve_perf_data,
