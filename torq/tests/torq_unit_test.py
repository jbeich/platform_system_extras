...
class TorqUnitTest(unittest.TestCase):
  ...
  def test_valid_perfetto_config_path(self):
    ...
    parser = self.set_up_parser("torq.py --perfetto-config defaul")
    self.verify_error_message(parser, ("Command is invalid because"
                                       " --perfetto-config is not a"
                                       " valid file path: defaul"))
  ...
  def test_app_and_event_dependency(self):
  ...
  def test_profiler_and_simpleperf_event_dependencies(self):
    parser = self.set_up_parser("torq.py -p simpleperf")
    args, error = self.prepare_arguments(parser)
  ...
  def test_multiple_simpleperf_events(self):
    parser = self.set_up_parser(("torq.py -p simpleperf -s cpu-cycles"
                                 " -s instructions"))
    self.validate_command(parser, "profiler")
    parser = self.set_up_parser(("torq.py -p simpleperf -s cpu-cycles"
  ...
  def test_profiler_and_perfetto_config_dependency(self):
  ...
  def test_runs_and_between_dur_ms_dependency(self):
  ...
  def test_ui_and_runs_dependencies(self):
    parser = self.set_up_parser("torq.py")
    args, error = self.prepare_arguments(parser)
  ...
  def test_profiler_and_ftrace_events_dependencies(self):
  ...
  def test_hw_set_dependencies(self):
