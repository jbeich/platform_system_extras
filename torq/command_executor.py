...
class ProfilerCommandExecutor(CommandExecutor):
  """
  Used to execute the class ProfilerCommand.
  """
...
class HWCommandExecutor(CommandExecutor):
  """
  Used to execute the class HWCommand.
  """
  ...
  def execute_command(self, hw_command, device):
    match hw_command.get_type():
      ...
      case _:
        raise Exception("Invalid hw subcommand was used. Use of the following:"
                        " hw set, hw get, hw list")
...
class ConfigCommandExecutor(CommandExecutor):
  """
  Used to execute the class ConfigCommand.
  """
  ...
  def execute_command(self, config_command, device):
    match config_command.get_type():
      ...
      case _:
        raise Exception("Invalid config subcommand was used. Use of the"
                        " following: config list, config show, config pull")
