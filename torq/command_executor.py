...
class ProfilerCommandExecutor(CommandExecutor):
  """
  Class representing a profiler command executor, used to execute the class
  ProfilerCommand.
  """
...
class HWCommandExecutor(CommandExecutor):
  """
  Class representing a hw command executor, used to execute the class
  HWCommand.
  """
...
class ConfigCommandExecutor(CommandExecutor):
  """
  Class representing a config command executor, used to execute the class
  ConfigCommand.
  """
