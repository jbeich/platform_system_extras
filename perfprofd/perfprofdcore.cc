...
static void set_seed(ConfigReader &config)
{
  ...
  // Distribute the 32-bit seed into the three 16-bit array elements. The specific values being
  // written do not especially matter as long as we are setting them something based on the seed.
