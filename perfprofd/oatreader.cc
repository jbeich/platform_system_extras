...
class OatDataReader : public OatReaderHooks {
 public:
  ...
  void setupClass(uint32_t classIdx);
  void setupMethod(uint32_t methodIdx);
  uint64_t getMethodNativeCodeOffset();
...
void OatDataReader::setupClass(uint32_t classIdx)
{
}

void OatDataReader::setupMethod(uint32_t methodIdx)
{
}

uint64_t OatDataReader::getMethodNativeCodeOffset()
{
  return 0;
}
