...
#
# Static library containing oat reader and visitor utility
#
include $(CLEAR_VARS)
LOCAL_CLANG := true
LOCAL_CPP_EXTENSION := .cc
LOCAL_MODULE := libperfprofdoatreader
LOCAL_MODULE_TAGS := debug
LOCAL_STATIC_LIBRARIES := libbase
LOCAL_SRC_FILES := oatreader.cc oatdexvisitor.cc
include art/build/Android.common_build.mk
LOCAL_CPPFLAGS += $(perfprofd_cppflags) $(ART_TARGET_CFLAGS)
LOCAL_C_INCLUDES += art/runtime $(ART_C_INCLUDES)
include $(BUILD_STATIC_LIBRARY)

#
# Static library libperfprofdoatutils containing OAT mapper machinery.
#
include $(CLEAR_VARS)
LOCAL_CLANG := true
LOCAL_CPP_EXTENSION := .cc
...
LOCAL_STATIC_LIBRARIES := \
	...
	libbase
LOCAL_EXPORT_C_INCLUDE_DIRS += $(proto_header_dir)
LOCAL_SRC_FILES := oatmapper.cc genoatmap.cc
LOCAL_CPPFLAGS += $(perfprofd_cppflags)
include $(LLVM_DEVICE_BUILD_MK)
include $(BUILD_STATIC_LIBRARY)

#
# genoatmap executable for testing purposes
#
include $(CLEAR_VARS)
LOCAL_CLANG := true
LOCAL_CPP_EXTENSION := .cc
