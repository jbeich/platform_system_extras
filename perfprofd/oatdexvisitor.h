...
//
// Interface class for clients to examine stand-alone DEX files or DEX
// files embedded within an OAT file. Clients should inherit from
// OatDexVisitor and override methods depending on which bits they
// want to visit.
//
class OatDexVisitor {
 public:
