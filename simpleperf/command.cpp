...
static std::vector<Command*>& Commands() {
  // commands is used in other global object constructors. Define it as a static
  // variable in a function makes sure it is initialized before used.
  static std::vector<Command*> commands;
  return commands;
}

Command* Command::FindCommand(const std::string& cmd_name) {
