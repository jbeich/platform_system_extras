...
inline const OptionFormatMap& GetStatCmdOptionFormats() {
  static const OptionFormatMap option_formats = {
    ...
    {"--interval-only-values", {OptionValueType::NONE, OptionType::SINGLE, AppRunnerType::ALLOWED}},
    ...
    {"--tracepoint-events", {OptionValueType::STRING, OptionType::SINGLE, AppRunnerType::CHECK_PATH}},
    {"--use-devfreq-counters", {OptionValueType::NONE, OptionType::SINGLE, AppRunnerType::NOT_ALLOWED}},
