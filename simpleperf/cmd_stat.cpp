...
"                 all possible event names. For implementation-defined events,\n"
"                 pass as rNNN (NNN is a hex number), e.g. r11. Modifiers can\n"
"                 be added to define how the event should be monitored.\n"
