...
bool Event::Supported() const {
  if (support_state == SupportState::UnChecked) {
...
// Below contents are generated events by gen_events.rb.

Event cpu_cycles_event{"cpu-cycles", PERF_TYPE_HARDWARE,
  PERF_COUNT_HW_CPU_CYCLES};
Event instructions_event{"instructions", PERF_TYPE_HARDWARE,
  PERF_COUNT_HW_INSTRUCTIONS};
Event cache_references_event{"cache-references", PERF_TYPE_HARDWARE,
  PERF_COUNT_HW_CACHE_REFERENCES};
Event cache_misses_event{"cache-misses", PERF_TYPE_HARDWARE,
  PERF_COUNT_HW_CACHE_MISSES};
Event branch_instructions_event{"branch-instructions", PERF_TYPE_HARDWARE,
  PERF_COUNT_HW_BRANCH_INSTRUCTIONS};
Event branch_misses_event{"branch-misses", PERF_TYPE_HARDWARE,
  PERF_COUNT_HW_BRANCH_MISSES};
Event bus_cycles_event{"bus-cycles", PERF_TYPE_HARDWARE,
  PERF_COUNT_HW_BUS_CYCLES};
Event stalled_cycles_frontend_event{"stalled-cycles-frontend", PERF_TYPE_HARDWARE,
  PERF_COUNT_HW_STALLED_CYCLES_FRONTEND};
Event stalled_cycles_backend_event{"stalled-cycles-backend", PERF_TYPE_HARDWARE,
...
Event cpu_clock_event{"cpu-clock", PERF_TYPE_SOFTWARE,
  PERF_COUNT_SW_CPU_CLOCK};
Event task_clock_event{"task-clock", PERF_TYPE_SOFTWARE,
  PERF_COUNT_SW_TASK_CLOCK};
Event page_faults_event{"page-faults", PERF_TYPE_SOFTWARE,
  PERF_COUNT_SW_PAGE_FAULTS};
Event context_switches_event{"context-switches", PERF_TYPE_SOFTWARE,
  PERF_COUNT_SW_CONTEXT_SWITCHES};
Event cpu_migrations_event{"cpu-migrations", PERF_TYPE_SOFTWARE,
  PERF_COUNT_SW_CPU_MIGRATIONS};
Event minor_faults_event{"minor-faults", PERF_TYPE_SOFTWARE,
  PERF_COUNT_SW_PAGE_FAULTS_MIN};
Event major_faults_event{"major-faults", PERF_TYPE_SOFTWARE,
  PERF_COUNT_SW_PAGE_FAULTS_MAJ};
Event alignment_faults_event{"alignment-faults", PERF_TYPE_SOFTWARE,
  PERF_COUNT_SW_ALIGNMENT_FAULTS};
Event emulation_faults_event{"emulation-faults", PERF_TYPE_SOFTWARE,
  PERF_COUNT_SW_EMULATION_FAULTS};

std::vector<const Event*> software_events{
                                          &cpu_clock_event,
                                          &task_clock_event,
                                          &page_faults_event,
