...
// Because we want to cast char* to UnixSocketMessage*, we have to make
// sure the start of the message is 4 bytes aligned, in order to access
// msg->len and msg->type properly.
