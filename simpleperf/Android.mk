...
simpleperf_common_cppflags := \
    -Wextra \
    -Wunused \
    -Wno-unknown-pragmas \

simpleperf_c_includes_host_darwin := $(LOCAL_PATH)/nonlinux_support/include
simpleperf_c_includes_host_windows := $(LOCAL_PATH)/nonlinux_support/include
...
LOCAL_CPPFLAGS := $(simpleperf_common_cppflags)
LOCAL_C_INCLUDES_darwin := $(simpleperf_c_includes_host_darwin)
LOCAL_C_INCLUDES_windows := $(simpleperf_c_includes_host_windows)
