...
[here](report.html). Report are self-contained in HTML so they can be exchanged
easily.
...
from which all flames originate, it is likely that stack unwinding failed while
recording callstacks. To solve this problem, double check you compiled without
