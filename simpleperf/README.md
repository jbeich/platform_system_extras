...
1. Aware of Android environment
  Simpleperf handles some Android specific situations like below:
...
2. Using python scripts for profiling tasks
  It contains python scripts to help record and report profiling data.
...
[Here](https://github.com/yabinc/simpleperf_demo) are examples. And we use
[SimpleperfExamplePureJava](https://github.com/yabinc/simpleperf_demo/tree/master/SimpleperfExamplePureJava) project to show the profiling results.
...
Check [here](https://github.com/yabinc/simpleperf_demo/blob/master/SimpleperfExamplePureJava/app/profiling.gradle)
...
This makes C++ code slow. Check [here](https://github.com/yabinc/simpleperf_demo/blob/master/SimpleperfExamplePureJava/app/profiling.gradle)
...
results. Check [here](https://github.com/yabinc/simpleperf_demo/blob/master/SimpleperfExamplePureJava/app/profiling.gradle)
for how to use unstripped libraries.

Here we use [SimpleperfExamplePureJava](https://github.com/yabinc/simpleperf_demo/tree/master/SimpleperfExamplePureJava) as an example.
It builds an app-profiling.apk for profiling.

    # git clone https://github.com/yabinc/simpleperf_demo.git
