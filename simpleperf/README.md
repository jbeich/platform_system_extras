...
- [Answers to common issues](#answers-to-common-issues)
    ...
    - [Profile in Android emulators](#profile-in-android-emulators)
...
### Profile in Android emulators
In Android emulators, the hardware events are not available, but we can use
...
In Android emulators, the dwarf based call graph may not be supported by the
