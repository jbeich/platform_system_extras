...
"--no-cut-samples       By default, part of the stack data in samples will be dropped\n"
"                       when the record buffer is near overflow. This option drops\n"
"                       the whole sample instead of part of its stack data.\n"
"\n"
