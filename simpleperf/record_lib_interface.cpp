...
class PerfEventSetImpl : public PerfEventSet {
 public:
  ...
  bool MonitorThreadsInCurrentProcess(const std::vector<int>& threads) override {
    whole_process_ = false;
...
class PerfEventSetForCounting : public PerfEventSetImpl {
 public:
  ...
  bool StartCounting() override;
  bool StopCounting() override;
  bool ReadCounters(std::vector<Counter>* counters) override;
  bool FinishCounting() override;
...
bool PerfEventSetForCounting::StartCounting() {
...
bool PerfEventSetForCounting::StopCounting() {
  if (!in_counting_state_) {
    return true;
  }
...
bool PerfEventSetForCounting::FinishCounting() {
  in_counting_state_ = false;
  event_selection_set_ = nullptr;
  return true;
}

PerfEventSet* PerfEventSet::CreateInstance(bool for_counting) {
  if (for_counting) {
...
bool PerfEventSet::MonitorThreadsInCurrentProcess(const std::vector<int>&) {
  return false;
}

bool PerfEventSet::StartCounting() {
  return false;
}

bool PerfEventSet::StopCounting() {
  return false;
}
...
bool PerfEventSet::FinishCounting() {
  return false;
}
