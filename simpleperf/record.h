...
// sample_id_all and sample_type in perf_event_attr. Copy sample_id_all and sample_type inside
// the SampleId structure, so we don't need to refer to perf_event_attr when analyzing its content.
struct SampleId {
  bool sample_id_all;
