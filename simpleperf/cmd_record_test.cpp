...
<<<<<<< TARGET BRANCH (f9cef3 Merge "simpleperf: update test apk to run on wear devices." )
...
=======
  ...
  ASSERT_TRUE(has_sample);
>>>>>>> SOURCE BRANCH (f33a79 Merge "simpleperf: increase record duration" into android10-)
