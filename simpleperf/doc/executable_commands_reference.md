...
smaller than the number of events actually happened. Following is an example.
...
And the number of instructions is zero. After printing result, simpleperf checks if CPUs have
