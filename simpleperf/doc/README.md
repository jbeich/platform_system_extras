...
This script pushes the simpleperf executable on device, and run a simpleperf command on device.
It is more convenient than running adb commands manually.
...
Below is an example of generated html profiling results for SimpleperfExampleWithNative project.
