...
Android also has a daemon collecting ETM data periodically. It only runs on userdebug and eng devices.
The source code is in `<aosp-top>/system/extras/profcollectd`.
