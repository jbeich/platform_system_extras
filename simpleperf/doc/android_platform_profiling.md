...
a background process to run simpleperf to record boot-time profile.
...
4.5s after booting. So simpleperf can record boot-time profile starting from about 4.5s after booting.
