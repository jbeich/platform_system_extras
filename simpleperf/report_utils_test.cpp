...
<<<<<<< TARGET BRANCH (dd4402 Merge "Merge "simpleperf: assume gpc targets as emulator" in)
    SetSymbols(
...
>>>>>>> SOURCE BRANCH (b2dee2 Merge "Merge "simpleperf: fix check_trampoline_after_art_jni)
