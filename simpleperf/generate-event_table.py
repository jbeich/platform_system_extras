...
def gen_event_definition_str(variable_name, event_name, type_name, config):
    """
    return string like:
    Event cpu_cycles_event{"cpu-cycles", PERF_TYPE_HARDWARE, PERF_COUNT_HW_CPU_CYCLES};
    """
...
def gen_hardware_events():
    ...
    generated_str += "\n" + \
        gen_event_array_definition_str(
...
def gen_hw_cache_events():
    ...
    generated_str += '\n' + \
        gen_event_array_definition_str(
            "hwcache_events", hw_cache_events) + '\n'
    return generated_str
