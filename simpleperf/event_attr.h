...
// EventAttr manages perf_event_attr, which provides detailed configuration information for
// the event being created. EventAttr can be used to tell how to monitor an event.
class EventAttr {
 public:
  ...
  static EventAttr CreateDefaultAttrToMonitorAnEvent(const Event& event);
