...
class EventFd {
 ...
 private:
  ...
  // Because mmap_data_buffer is a ring buffer, it is possible that one record is wrapped in the
  // buffer. So we need to copy records from mmap_data_buffer to data_process_buffer before
  // processing them.
