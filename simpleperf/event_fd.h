...
class EventFd {
 ...
 private:
  ...
  // Because mmap_data_buffer is a ring buffer. It is possible that one record doesn't resides in
  // a continuous memory. So we need to copy records from mmap_data_buffer to data_process_buffer
