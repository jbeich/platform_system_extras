...
__attribute__((__unused__)) static const char* DEFAULT_KERNEL_MMAP_NAME = "[kernel.kallsyms]_text";
...
__attribute__((__unused__)) static const char* DEFAULT_EXECNAME_FOR_THREAD_MMAP = "//anon";
...
__attribute__((__unused__)) static const
    char* DEFAULT_KERNEL_FILENAME_FOR_BUILD_ID = "[kernel.kallsyms]";
