...
void ShowInterpreterFrames(ReportLib* report_lib, bool show) EXPORT;
...
class ReportLib {
 public:
  ReportLib()
      : log_severity_(
        ...
        trace_offcpu_(false),
        remove_interpreter_frames_(true) {
  }
  ...
  void ShowInterpreterFrames(bool show) { remove_interpreter_frames_ = !show; }
 ...
 private:
  ...
  bool remove_interpreter_frames_;
};
...
void ShowInterpreterFrames(ReportLib* report_lib, bool show) {
  return report_lib->ShowInterpreterFrames(show);
}
