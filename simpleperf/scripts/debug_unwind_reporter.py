...
1. Record with "-g --keep-failed-unwinding-debug-info" option on device.
    $ simpleperf record -g --keep-failed-unwinding-debug-info --app com.google.sample.tunnel --duration 10
...
2. Generate report with debug-unwind cmd.
    ...
    The report contains details for each failed unwinding case, which is usually too long to
