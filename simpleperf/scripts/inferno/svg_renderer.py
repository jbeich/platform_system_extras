...
def renderSearchNode(f):
    f.write(
        ...
        """ % (SEARCH_NODE_X, SEARCH_NODE_WIDTH, SEARCH_NODE_X + RECT_TEXT_SPACE))
...
def renderUnzoomNode(f):
    f.write(
        ...
        """ % (UNZOOM_NODE_X, UNZOOM_NODE_WIDTH, UNZOOM_NODE_X + RECT_TEXT_SPACE))
...
def renderInfoNode(f):
    f.write(
        ...
        rx="10" ry="10" x="%d" y="10" width="%d" height="30" fill="rgb(255,255,255)"/>
         ...
         """ % (INFO_NODE_X, INFO_NODE_WIDTH, INFO_NODE_X, INFO_NODE_WIDTH,
                INFO_NODE_X + RECT_TEXT_SPACE))
...
def renderPercentNode(f):
    f.write(
        ...
        """ % (PERCENT_NODE_X, PERCENT_NODE_WIDTH,
               PERCENT_NODE_X + PERCENT_NODE_WIDTH - RECT_TEXT_SPACE))
