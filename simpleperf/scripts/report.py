...
def main():
    ...
    while i < len(args):
        if args[i] == '-h' or args[i] == '--help':
            print('To report profiling data in text format:')
            print('    report.py [simpleperf report cmd options]')
            print('    Example: report.py -g -i perf.data')
            print('\nTo report profiling data in gui format:')
            print('    report.py [simpleperf report cmd options] --gui')
            print('    Example: report.py -g -i perf.data --gui')
            print('\nTo show text report in gui format:')
            print('    report.py report_file')
            print('    Example: report.py -g >perf.report')
            print('             report.py perf.report')
            print('\nSimpleperf report cmd options:')
