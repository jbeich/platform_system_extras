...
INSTALL_LIST = [
    ...
    InstallEntry('MODULES-IN-system-extras-simpleperf', 'simpleperf/android/arm64/simpleperf_ndk64', 'android/arm64/simpleperf'),
    InstallEntry('MODULES-IN-system-extras-simpleperf', 'simpleperf/android/arm/simpleperf_ndk', 'android/arm/simpleperf'),
    InstallEntry('MODULES-IN-system-extras-simpleperf_x86', 'simpleperf/android/x86_64/simpleperf_ndk64', 'android/x86_64/simpleperf'),
    InstallEntry('MODULES-IN-system-extras-simpleperf_x86', 'simpleperf/android/x86/simpleperf_ndk', 'android/x86/simpleperf'),

    # simpleperf on host. Linux and macOS are 64-bit only these days.
    InstallEntry('MODULES-IN-system-extras-simpleperf', 'simpleperf/linux/x86_64/simpleperf_ndk64', 'linux/x86_64/simpleperf', True),
    InstallEntry('MODULES-IN-system-extras-simpleperf_mac', 'simpleperf/darwin/x86_64/simpleperf_ndk64', 'darwin/x86_64/simpleperf'),
    # TODO: simpleperf.exe on x86_64 windows doesn't work, use simpleperf_ndk.exe twice instead.
    InstallEntry('MODULES-IN-system-extras-simpleperf', 'simpleperf/windows/x86/simpleperf_ndk.exe', 'windows/x86_64/simpleperf.exe', True),
    InstallEntry('MODULES-IN-system-extras-simpleperf', 'simpleperf/windows/x86/simpleperf_ndk.exe', 'windows/x86/simpleperf.exe', True),

    # libsimpleperf_report.so on host
    InstallEntry('MODULES-IN-system-extras-simpleperf', 'simpleperf/linux/x86_64/libsimpleperf_report.so', 'linux/x86_64/libsimpleperf_report.so', True),
    InstallEntry('MODULES-IN-system-extras-simpleperf_mac', 'simpleperf/darwin/x86_64/libsimpleperf_report.dylib', 'darwin/x86_64/libsimpleperf_report.dylib'),
    # TODO: why do we copy the 64-bit DLL (given the TODO above)?
    InstallEntry('MODULES-IN-system-extras-simpleperf', 'simpleperf/windows/x86_64/libsimpleperf_report.dll', 'windows/x86_64/libsimpleperf_report.dll', True),
    InstallEntry('MODULES-IN-system-extras-simpleperf', 'simpleperf/windows/x86/libsimpleperf_report.dll', 'windows/x86/libsimpleperf_report.dll', True),
