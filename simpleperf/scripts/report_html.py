...
class RecordData(object):
    ...
    def load_record_file(self, record_file, show_interpreter_frames):
        lib = ReportLib()
        ...
        if show_interpreter_frames:
            lib.ShowInterpreterFrames()
...
def gen_flamegraph(record_file, show_interpreter_frames):
    ...
    if show_interpreter_frames:
        args.append('--show-interpreter-frames')
...
def main():
    ...
    parser.add_argument('--show-interpreter-frames', action='store_true',
                        help='Show frames of Java interpreter.')
    ...
    for record_file in args.record_file:
        record_data.load_record_file(record_file, args.show_interpreter_frames)
    ...
    flamegraph = gen_flamegraph(args.record_file[0], args.show_interpreter_frames)
