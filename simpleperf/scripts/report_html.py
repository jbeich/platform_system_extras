...
class RecordData(object):
        ...
        All generated items are listed as below:
            ...
            9. functionMap: map from functionId to funcData.
                funcData = {
                    ...
                    d: [(disassembleCode, addr)] [optional]
                }
    ...
    def add_disassemble_code(self):
        """ Collect disassemble code information:
            1. Use objdump to collect disassemble code for each function in FunctionSet.
    ...
    def _gen_function_map(self):
        ...
        for func_id in sorted(self.functions.id_to_func):
            ...
            if function.disassemble_code:
                func_data['d'] = function.disassemble_code
...
def main():
    ...
    parser.add_argument('--add_disassemble_code', action='store_true', help="""
                        Add disassemble code.""")
    ...
    build_addr_hit_map = args.add_source_code or args.add_disassemble_code
