...
class TestBase(unittest.TestCase):
    ...
    def run_cmd(self, args, return_output=False, drop_output=True):
        ...
        try:
            ...
            subproc = subprocess.Popen(args, stdout=stdout_fd, stderr=TEST_LOGGER.log_fh, shell=use_shell)
    ...
    def run_addr2nearestline_test(self, with_function_name):
        ...
        for dso_path in test_map:
            ...
            for test_addr in test_addrs:
                ...
                if is_windows():
                    self.assertIsNotNone(actual_source, 'for %s:0x%x' % (dso_path, test_addr['addr']))
