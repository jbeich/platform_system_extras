...
class TestReportLib(unittest.TestCase):
    ...
    def test_show_interpreter_frames(self):
        def has_interpreter_frame(report_lib):
        ...
        self.assertFalse(has_interpreter_frame(report_lib))
        report_lib = ReportLib()
        report_lib.ShowInterpreterFrames(False)
        self.assertFalse(has_interpreter_frame(report_lib))
        report_lib = ReportLib()
        report_lib.ShowInterpreterFrames(True)
        self.assertTrue(has_interpreter_frame(report_lib))
