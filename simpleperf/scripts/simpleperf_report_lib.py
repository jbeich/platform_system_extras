...
class ProtoFileReportLib:
    ...
    def __init__(self):
        self.samples: List[report_sample_pb2.Sample] = []
        self.sample_index = -1
        self.files: List[report_sample_pb2.File] = []
        self.thread_map: Dict[int, report_sample_pb2.Thread] = {}
        self.meta_info: Optional[report_sample_pb2.MetaInfo] = None
    ...
    def SetRecordFile(self, record_file: str):
        ...
        while i < len(data):
            ...
            record = report_sample_pb2.Record()
