...
class ReportLib(object):
    ...
    def __init__(self, native_lib_path=None):
        ...
        self._ShowInterpreterFramesFunc = self._lib.ShowInterpreterFrames
    ...
    def ShowInterpreterFrames(self, show=True):
        """ Show frames of the Java interpreter in GetCallChainOfCurrentSamples(). """
        self._ShowInterpreterFramesFunc(self.getInstance(), show)
