...
class EventCountersStructure(ct.Structure):
...
class ReportLib(object):
    ...
    def __init__(self, native_lib_path: Optional[str] = None):
        ...
        self._GetEventCountersOfCurrentSampleFunc.restype = ct.POINTER(EventCountersStructure)
    ...
    def GetEventCountersOfCurrentSample(self) -> EventCountersStructure:
