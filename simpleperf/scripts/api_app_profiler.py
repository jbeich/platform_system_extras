...
"""
    ...
    profiling environment (download simpleperf and enabling profiling on device) before recording
...
def prepare_recording(args):
    ...
    download_simpleperf_on_device(adb, args)
...
def download_simpleperf_on_device(adb, args):
