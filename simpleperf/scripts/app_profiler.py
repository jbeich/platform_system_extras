...
arm, arm64, x86, x86_64. If not set, the script will try to detect it.""")
    parser.add_argument('-r', '--record_options', default="-e cpu-clock:u -g --duration 10", help=
"""Set options for `simpleperf record` command. Default is '-e cpu-clock:u -g --duration 10'.""")
