 ...
 public:
  TraceSchedCommand()
      : Command("trace-sched", "Trace system-wide process runtime events.",
                // clang-format off
"It records system-wide sched:sched_stat_runtime events, reports runtime taken\n"
"by each process during recording, and optionally warns processes which may\n"
"have spinloops.\n"
...
"        Give warning for threads which may spin on the CPU. A thread is\n"
