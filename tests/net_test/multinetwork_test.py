...
class PMTUTest(InboundMarkingTest):
  ...
  def testIPv4BasicPMTU(self):
    ...
    Relevant kernel commits:
      upstream net-next: 6a66271 ipv4, fib: pass LOOPBACK_IFINDEX instead of 0 to flowi4_iif
      android-3.10: 4bc64dd ipv4, fib: pass LOOPBACK_IFINDEX instead of 0 to flowi4_iif
    """
