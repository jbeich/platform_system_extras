...
class MultiInterfaceSourceAddressSelectionTest(IPv6SourceAddressSelectionTest):
  ...
  def setUp(self):
    ...
    # [2]  Delete the test interface's IPv6 address, if it hasn't already
    # been deleted by, say, a previous invocation of setUp().
    if self.iproute.GetAddress(self.test_ip):
